...
**Function:初始化函数
*************************************************************************************************************************************************/
void c_Fast_Scan_Remote::Init()
{
	c_Scan_Remote::Init();
	QObject::connect(m_Scan_Remote, &c_Scan_Client::Status, this, [=](int state) {emit Status(c_Variable::g_Current_Time + "->快扫相机：" + c_Variable::TCP_Status(state)); });
}
/*************************************************************************************************************************************************
**Function:操作接口
*************************************************************************************************************************************************/
